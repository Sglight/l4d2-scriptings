...
public OnPluginStart()
{
    ...
    g_hWeaponPitchFork          = CreateConVar( "l4d2_MITSR_PitchFork",     "1", "Number of pitchfork to spawn (l4d2_MITSR_Random must be 0)");
    g_hWeaponShovel          = CreateConVar( "l4d2_MITSR_Shovel",     "1", "Number of shovel to spawn (l4d2_MITSR_Random must be 0)");
