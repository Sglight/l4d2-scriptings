...
public OnPluginStart()
{
	...
	HookEvent("versus_round_start", EventHook:SetCommonLimit, EventHookMode_PostNoCopy);
	HookEvent("player_team", EventHook:SetCommonLimit, EventHookMode_PostNoCopy);
}

public OnMapStart()
{
	commonLimit = L4D2_GetMapValueInt("horde_limit_1", -1);
...
public void SetCommonLimit()
{
	...
	switch (survivorPlayers) {
		case 1: {
			commonLimit = L4D2_GetMapValueInt("horde_limit_1", -1);
		}
		case 2: {
			commonLimit = L4D2_GetMapValueInt("horde_limit_2", -1);
		}
		case 3: {
			commonLimit = L4D2_GetMapValueInt("horde_limit_3", -1);
		}
		case 4: {
			commonLimit = L4D2_GetMapValueInt("horde_limit_4", -1);
		}
	}
}
