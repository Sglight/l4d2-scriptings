...
public void OnPluginStart()
{
	...
	cvarWeaponAllowM2Hunter = CreateConVar("weapon_allow_m2_hunter", "", "allow specific primary weapon survivor to deadstop a hunter");
}
...
Action Shove_Handler(int shover, int shovee)
{
	...
	for (int i = 0; i < 32; i++) {
		...
		allowM2Weapon = allowM2WeaponArray[i];
	...
	if (bIsPouncing[shovee] && !isWeaponAllowDeadstop) {
