...
public OnPluginStart()
{
	...
	h_billEnabled = CreateConVar("l4d2_precache_bill", "1", "Toggle precaching of Bill's model to prevent crashes caused by sb_add", FCVAR_NOTIFY);	
	h_survivorsEnabled = CreateConVar("l4d2_precache_survivors", "1", "Toggle precaching of L4D1 survivor models to prevent crashes after the passing update", FCVAR_NOTIFY);

	h_m60Enabled = CreateConVar("l4d2_precache_m60", "1", "Toggle precaching of the m60 model to prevent crashes caused by z_spawn", FCVAR_NOTIFY);
	h_cssweaponsEnabled = CreateConVar("l4d2_precache_cssweapons", "1", "Toggle precaching of css weapon models to prevent crashes caused by z_spawn", FCVAR_NOTIFY);
	h_meleeEnabled = CreateConVar("l4d2_precache_melee", "1", "Toggle precaching of melee weapon models to prevent crashes caused by z_spawn", FCVAR_NOTIFY);

	h_miscEnabled = CreateConVar("l4d2_precache_misc", "1", "Toggle precaching of miscellaneous models to prevent crashes caused by z_spawn", FCVAR_NOTIFY);

	h_tankEnabled = CreateConVar("l4d2_precache_tank", "1", "Toggle precaching of tank models to prevent crashes caused by z_spawn", FCVAR_NOTIFY);
	h_witchEnabled = CreateConVar("l4d2_precache_witch", "1", "Toggle precaching of witch models to prevent crashes caused by z_spawn", FCVAR_NOTIFY);
	h_infectedEnabled = CreateConVar("l4d2_precache_infected", "1", "Toggle precaching of infected models to prevent crashes caused by z_spawn", FCVAR_NOTIFY);
...

{
	...
	if (!IsModelPrecached("models/v_models/v_smg_uzi.mdl")) PrecacheModel("models/v_models/v_smg_uzi.mdl");
